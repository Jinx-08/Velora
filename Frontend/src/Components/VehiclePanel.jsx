        ...
        <div>
            ...
            <div onClick={() => {
                ...
                <div className='ml-2 w-1/2'>
                    <h4 className='font-medium text-base flex border-solid items-center gap-1'>UberGo <span><User size={16} className="inline-block" />4</span></h4>
            ...
            <div onClick={() => {
                ...
                <div className='-ml-2 w-1/2'>
                    <h4 className='font-medium text-base flex border-solid items-center gap-1'>Moto <span><User size={16} className="inline-block" />1</span></h4>
            ...
            <div onClick={() => {
                ...
                <div className='ml-2 w-1/2'>
                    <h4 className='font-medium text-base flex border-solid items-center gap-1'>UberAuto <span><User size={16} className="inline-block" />3</span></h4>
                    <h5 className='font-medium text-sm'>3 mins away </h5>
