...
router.get('/profile', authmiddleware.authenticateCaptain, captaincontroller.getProfile);

router.post('/logout', authmiddleware.authenticateCaptain , captaincontroller.logoutCaptain);
